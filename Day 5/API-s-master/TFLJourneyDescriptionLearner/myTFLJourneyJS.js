...
var hours;
var minutes;
var googleApiKey = "AIzaSyDqwEMrYspWHOIjkw2EIX9vGwpb8IsL_o8";
...
function loadMyData() {
    ...
    myRequest.onload = function () {
        ...
        if (myRequest.readyState == 4 && myRequest.status == 200) {
            ...
            //MN: get your own google map api key!!!
            document.getElementById("myGoogleMap").setAttribute("src", "https://www.google.com/maps/embed/v1/directions?key=" + googleApiKey + "&origin=" + getDepPC + "&destination=" + getArrPC + "&mode=driving");
